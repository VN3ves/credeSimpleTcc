...
class UsuariosController extends MainController
{
    ...
    public function index()
    {
        ...
        $modeloEmpresa = $this->loadDefaultModel('EmpresasModel');

        if(chk_array($this->parametros, 0) == 'adicionar'){
            $this->title = SYS_NAME . ' - Adicionar Usuário';
            
            $conteudo = ABSPATH . '/core/views/usuarios/form.view.php';
        }
        else
            $conteudo = ABSPATH . '/core/views/usuarios/usuarios.view.php';
