...
class PessoasController extends MainController {
    ...
    public function index(){
		...
		$modelo = $this->loadDefaultModel('PessoasModel');
		...
		if(chk_array($this->parametros, 0) == 'adicionar'){
			...
			$conteudo = ABSPATH . '/core/views/pessoas/form.view.php';
			...
			$conteudo = ABSPATH . '/core/views/pessoas/perfil.view.php';
		}elseif(chk_array($this->parametros, 0) == 'trocar-minha-senha'){
			$this->title = SYS_NAME . ' - Trocar Minha Senha';
			
			$conteudo = ABSPATH . '/core/views/usuarios/trocar-minha-senha.view.php';
		}elseif(chk_array($this->parametros, 0) == 'usuarios'){
			$this->title = SYS_NAME . ' - Usuários';
		
			$conteudo = ABSPATH . '/core/views/usuarios/usuario.view.php';
		}else{
			$conteudo = ABSPATH . '/core/views/pessoas/pessoas.view.php';
		}
	...
	public function upload(){
		...
		require ABSPATH . '/core/views/pessoas/upload.view.php';
	}
}