...
require_once ABSPATH . '/core/libs/PHPMailer/src/Exception.php';
require_once ABSPATH . '/core/libs/PHPMailer/src/PHPMailer.php';
require_once ABSPATH . '/core/libs/PHPMailer/src/SMTP.php';
