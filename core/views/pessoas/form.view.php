...
<div class="content-wrapper">
	...
	if (chk_array($this->parametros, 0) == 'adicionar') {
		require ABSPATH . '/core/views/pessoas/frmPessoa.inc.view.php';
	} elseif (chk_array($this->parametros, 0) == 'editar') {
		if (chk_array($this->parametros, 2) == 'documentos') {
			require ABSPATH . '/core/views/pessoas/frmDocumentos.inc.view.php';
		} elseif (chk_array($this->parametros, 2) == 'enderecos') {
			require ABSPATH . '/core/views/pessoas/frmEnderecos.inc.view.php';
		} elseif (chk_array($this->parametros, 2) == 'emails') {
			require ABSPATH . '/core/views/pessoas/frmEmails.inc.view.php';
		} elseif (chk_array($this->parametros, 2) == 'telefones') {
			require ABSPATH . '/core/views/pessoas/frmTelefones.inc.view.php';
		} elseif (chk_array($this->parametros, 2) == 'arquivos') {
			require ABSPATH . '/core/views/pessoas/uploadArquivos.view.php';
		} else {
			require ABSPATH . '/core/views/pessoas/frmPessoa.inc.view.php';
		}
	}
